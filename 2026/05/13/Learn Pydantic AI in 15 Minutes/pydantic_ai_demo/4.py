...
agent = Agent(instructions="You are a transaction categorizer. Look up the merchant information only for the descriptions that aren't obvious. If you don't get a match, do your best to categorize it. Return the category for each transaction.")
